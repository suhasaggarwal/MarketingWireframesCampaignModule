				...
				if (date.equals(dates.get(j)) == false) {
					...
					if (reportCode == 1) {
						if (campaignIds.contains(Report.get(i).getCampaign_id()) == false) {
						   ...
						   if(Report.get(i).getChannel().equals("Facebook"))
						   {
							    report2.setDate(dates.get(j));
								report2.setCampaign_id(Report.get(i).getCampaign_id());
								report2.setImpressions("0");
								report2.setChannel("DBM");
								campaignIds.add(Report.get(i).getCampaign_id());
								Report.add(report2);
							    System.out.println(Report.toString()); 
							   
							    
							     report3.setDate(dates.get(j));
							     report3.setCampaign_id(Report.get(i).getCampaign_id());
								 report3.setImpressions("0");
								 report3.setChannel("Adwords");
								 campaignIds.add(Report.get(i).getCampaign_id());
							     Report.add(report3);
							     System.out.println(Report.toString()); 
						   ...
						   if(Report.get(i).getChannel().equals("DBM"))
						   {
							    report2.setDate(dates.get(j));
								report2.setCampaign_id(Report.get(i).getCampaign_id());
								report2.setImpressions("0");
								report2.setChannel("Facebook");
								campaignIds.add(Report.get(i).getCampaign_id());
								Report.add(report2);
							    System.out.println(Report.toString()); 
						   ...
						   if(Report.get(i).getChannel().equals("Adwords"))
						   {
							    report2.setDate(dates.get(j));
								report2.setCampaign_id(Report.get(i).getCampaign_id());
								report2.setImpressions("0");
